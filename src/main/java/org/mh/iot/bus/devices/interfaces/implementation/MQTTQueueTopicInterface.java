 ...
 */
@Component("mqttQueueTopicInterface")
public class MQTTQueueTopicInterface extends MQTTInterface {


    @Override
    public void sendNotification(String message, String connectionString) throws CannotSendMessage {
        super.sendMessageAsync(message, "activemq:queue:" + connectionString);
    }
    ...
    public String sendRequest(String message, String requestConnectionString, String replyConnectionString, MessageSelector selector, int timeout) throws CannotSendMessage, MessageNotReceived{
        return super.sendRequestReplyAsync(message, "activemq:queue:" + requestConnectionString, "activemq:topic:" + replyConnectionString, selector, timeout);
    }
